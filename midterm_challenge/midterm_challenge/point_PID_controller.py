...
class PointPIDController(Node):
    def __init__(self):
        ...
        self.max_vel_sub = self.create_subscription(Float32, '/max_vel', self.max_vel_callback, 10)
    ...
    def max_vel_callback(self, msg: Float32):
        self.max_linear_vel = msg.data
        self.get_logger().debug(f'max_linear_vel updated to {self.max_linear_vel:.2f}')
